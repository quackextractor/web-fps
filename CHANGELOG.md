...
## [0.11.5] - 2026-03-27 [Author: Pavlo Kosov]
### Added
- Exported full repository commit history to `docs/commit-history.txt` to provide a permanent, verifiable record of all team contributions (Fixes #73).
